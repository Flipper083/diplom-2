...
public class ClientCreateTest {
    ...
    public void tearDown() {
        if (accessToken != null) {
            userClient.deleteClient(accessToken); // Удаляем клиента по accessToken
        }
    }

    @Test
    @DisplayName("Client create by valid credentials")
    @Description("This test checks the creation of a client with valid credentials.")
    ...
    @Description("This test checks the error message when trying to create a client with an empty email.")
    ...
    @Description("This test checks the error message when trying to create a client with an empty password.")
    ...
    @Description("This test checks the error message when trying to create a client with an empty name.")
    ...
    @Description("This test checks the error message when trying to create a client that already exists.")
